...
| alpha.29 | 2026-08-11 | "Capability factory ergonomics", 11 items ([#65](https://github.com/baabakk/llm-ports/discussions/65)) | Runtime observability instrumentation. **0 of 11** | Nowhere. Re-queued 2026-08-21 as alpha.37. Items recovered and scored 2026-09-05: [`alpha.29-capability-factory-ergonomics.md`](./alpha.29-capability-factory-ergonomics.md) |
| alpha.30 | 2026-08-14 | "Persistent backends + caching", 2 items plus a bonus ([#66](https://github.com/baabakk/llm-ports/discussions/66)) | Streaming instrumentation, adapter-side emission, OpenTelemetry bridge. **0 of 2** | Nowhere. Re-queued 2026-08-21 as alpha.35 (budget) and alpha.36 (cache). Items recovered and scored 2026-09-05: [`alpha.30-persistent-backends-and-caching.md`](./alpha.30-persistent-backends-and-caching.md) |
| alpha.31 | 2026-08-19 | "Local runtime + orchestration", 3 items ([#67](https://github.com/baabakk/llm-ports/discussions/67)) | A single-issue `operation_id` hotfix. **0 of 3** | Withdrawal proposed 2026-08-21 on the grounds that it contradicted the v0.3 roadmap's placement of browser-native inference. Items recovered 2026-09-05 and **that reasoning does not survive them**: the ask is `adapter-transformers-node`, Node-side, plus a runtime-independent pipeline primitive. Decision reopened. See [`alpha.31-local-runtime-and-orchestration.md`](./alpha.31-local-runtime-and-orchestration.md) |
