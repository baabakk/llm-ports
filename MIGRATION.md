...
|---|---|---|---|---|
| alpha.34 | 2026-09-16 | Configuration that survives an incomplete deployment; unknown cost reported as unknown; core becomes a peer dependency | **TS-BREAKING**: `cost` is optional, and `AdapterRegistration.pricing` can be `"free"`. Behaviour changes to registry construction, pricing admission and cost telemetry. | [docs/migration/alpha-33-to-alpha-34.md](docs/migration/alpha-33-to-alpha-34.md) |
